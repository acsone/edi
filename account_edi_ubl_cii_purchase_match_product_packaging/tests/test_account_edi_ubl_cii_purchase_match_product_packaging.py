...
class TestAccountEdiUblCiiPurchaseMatchProductPackaging(AccountTestInvoicingCommon):
    ...
    def test_0(self):
        """
        the UNECE unit code from the UBL file is stored on the invoice line during import
        """
        file_path = (
        ...
        self.assertEqual(line.unece_unit_code, "DPC")
    ...
    def test_2(self):
        ...
        line = bill.invoice_line_ids
        self.assertEqual(line.unece_unit_code, "X8A")
        ...
        self.assertEqual(line.product_packaging_id, packaging)
