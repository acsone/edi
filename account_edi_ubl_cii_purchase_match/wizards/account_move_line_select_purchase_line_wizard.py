...
class AccountMoveLineSelectPurchaseLineWizard(models.TransientModel):
    ...
    move_line_price_unit = fields.Float(related="move_line_id.price_unit")
    move_line_price_subtotal = fields.Monetary(related="move_line_id.price_subtotal")
    ...
    po_line_price_unit = fields.Float(related="purchase_order_line_id.price_unit")
